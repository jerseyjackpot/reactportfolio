        ...
        <>
            <Row className="portfolio-row">
                ...
                <Col>
                    <br></br>
                        ...
                        <p className="portfolio-content">Virtual Art Gallery is an interactive site that enables a user to create
            ...
            <Row className="portfolio-row">
                <Col>
                    <br></br>
                        <h4>Life Point</h4>
                        <p className="portfolio-content">Life point is an all in one source for reminders, mood and habit tracking, a daily
            ...
            <Row className="portfolio-row">
                ...
                <Col>
                    <br></br>
                    <h4>Eat Da Burger</h4>
                        <p className="portfolio-content">Eat Da Burger is a javascript page deployed on heroku that utilizes handlebars to display database information on the HTML page. 
            ...
            <Row className="portfolio-row">
                <Col>
                    <br></br>
                    <h4>Day Planner</h4>
                        <p className="portfolio-content">Created a simple calendar application that allows the user to save events for each hour of the day. This app features dynamically 
            ...
            <Row className="portfolio-row">
                ...
                <Col>
                    ...
                    <h4>Astronomy Quiz</h4>
                        <p className="portfolio-content">Astronomy Quiz is a timed javascript game that asks a round of dynamically rendered questions.
            ...
            <Row className="portfolio-row">
                <Col>
                    <br></br>
                        ...
                        <p className="portfolio-content">Weather Dashboard is a javascript page that utilizes the OpenWeather API to retrieve weather data for cities.
